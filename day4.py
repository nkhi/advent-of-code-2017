#AoC Day 4 -- High Entropy Passphrases
...
for line in file:
    splitt = line.split()
    if len(set(splitt)) == len(splitt):
        valids += 1
print(valids)

# Part 2
# Working on it, moved on because the solution seemed too large 
# and i'm already behind on other days from exams.
